 ...
 */
class InvenioRdmResponse implements TransportResponse {
    private final boolean success;
    private final Throwable throwable;
    private final String depositAccessUrl;

    InvenioRdmResponse(boolean success, String depositAccessUrl) {
        this(success, depositAccessUrl, null);
    }

    InvenioRdmResponse(boolean success, String depositAccessUrl, Throwable throwable) {
